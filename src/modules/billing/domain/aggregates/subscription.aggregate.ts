 ...
 * ACTIVE apenas com pagamento válido + plano activo + startDate válida (policy).
 */
export class Subscription extends AggregateRoot {
  ...
  activate(params: { planIsActive: boolean; hasValidPayment: boolean; startDate: Date }): void {
